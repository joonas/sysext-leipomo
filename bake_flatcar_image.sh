...
bakery_base_url="https://github.com/joonas/sysext-leipomo/releases/download/latest"
...
function print_help() {
    ...
    echo "                            Bakery release (https://github.com/joonas/sysext-leipomo/releases/tag/latest)."
